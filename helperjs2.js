(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.helperjs2 = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
(function (global){
// browserify -s someGlobal entry.js -o bundle.js
// browserify -s helperjs2 helperjs2.js -o helperjs2bundle.js
...
h.proto = {HTMLElement: {}, String: {}, Array: {}, Math: {}, Date: {}}
...
if (h.library_settings.timer_prototypes) {
 void function () {
  ...
  h.proto.HTMLElement.set_interval_upgraded = function (obj, callback, calltime) {
   ...
   return t = set_interval_upgraded (callback_wrapper, calltime)
  }
...
if (h.library_settings.object_manipulation) {
 ...
 h.proto.Array.send_to_front        = function (obj, target) {
  var newobj = obj.map (element => element)
 ...
 h.proto.Array.remove_empty_strings = function (obj) {return obj.filter (element => element != "")}// for (var i = 0, curlen = obj.length; i < curlen; i++) {if (obj[i] != "") continue; obj.splice (i, 1); curlen -= 1; i -= 1; }; return obj
 h.proto.Array.multiply             = function (obj, mult_value)           {return obj.map (element => element * mult_value)}  // for (var i = 0, curlen = obj.length; i < curlen; i++) {obj[i] *= mult_value}; return obj
 h.proto.Array.round  = function (obj) {function round (obj) {return obj.map (element => Math.round(element))}}  // for (var i = 0, curlen = obj.length; i < curlen; i++) {obj[i] = Math.round(obj[i])}; return obj
 h.proto.Array.add    = function (obj, add_value)            {return obj.map (element => element +  add_value)}  // for (var i = 0, curlen = obj.length; i < curlen; i++) {obj[i] += add_value}; return obj
...
if (h.library_settings.date_manipulation) {
 void function () {
  ...
  h.proto.Date.get_month_name= function (obj) {return monthName[obj.getMonth()]}
 ...
 // For convenience...
 h.proto.Date.format = function (mask, utc) {return h.date_format(this, mask, utc)}
}
// <Date manipulation functions.>

// <String manipulation functions. TAG: string, string manipulation.>
if (h.library_settings.string_manipulation) {
 h.proto.String.repeat = function (num) {return new Array(num + 1).join(obj)}
 h.proto.String.to_char_code = String.prototype.charCodeAt
 // Check if any character in the search string is in any character in the target string. Otherwise, return false.
 h.proto.String.index_of_multi_char = function (searchstring, startpos) {
...
if (h.library_settings.dom_position) {
 ...
 h.get_x  = function (evt, target) {
  if (typeof target == "undefined") target = evt.target
  return evt.clientX - target.getBoundingClientRect().left
 }
 h.get_y  = function (evt, target) {
  if (typeof target == "undefined") target = evt.target
...
// <DOM object prototypes. TAG: DOM, TAG: DOM objects, TAG: prototypes.>
 ...
 focus_default_text    = function (focus_obj, default_text) {if (focus_obj.value == default_text) focus_obj.value = ""}
 blur_default_text     = function (focus_obj, default_text) {if (focus_obj.value == '') focus_obj.value = default_text}
...
if (h.library_settings.audio) {
 h.play_audio = function (filename, init) {
 ...
 h.proto.HTMLElement.playAudio = function () {
